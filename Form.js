class Form{
    constructor(){
        ...
        this.question2 = createElement('h3', "Q2. Do you think there shd be a participation reward for esports ?");
        this.radio1 = createRadio('h4');
        this.radio1.option('Yes :)');
        this.radio1.option('Nope :(');
        this.question3 = createElement('h3', "Q3.How was Hackathon was fair since in pac man the ghosts were toofast  ? ");
        this.radio2 = createRadio('h4');
        this.radio2.option('challenging  :)');
        this.radio2.option('took me the 1 hour XD');
